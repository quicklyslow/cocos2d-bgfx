...
WebSocket::~WebSocket()
{
    ...
    if (_impl != nil)
    {
        SharedDirector.getEventDispatcher()->removeEventListener(_impl.resetDirectorListener);
    }
}
                     ...
                     const std::string& caFilePath/* = ""*/)
{
    ...
    if (_impl != nil)
    {
        _impl.resetDirectorListener = SharedDirector.getEventDispatcher()->addCustomEventListener(cocos2d::Director::EVENT_RESET, [this](cocos2d::EventCustom*){
            close();
        });
    }
