...
namespace creator {
    ...
    void CameraNode::setTransform(float a, float b, float c, float d, float tx, float ty)
    {
        ...
        _visibleRect.origin = SharedDirector.getVisibleOrigin();
        _visibleRect.size = SharedDirector.getVisibleSize();
    ...
    void CameraNode::addTarget(Node* target)
    {
        ...
        //
        //target->setBeforeVisitCallback([this, beforeVisitCommand](IRenderer* renderer) {
        ...
        //});
        //target->setAfterVisitCallback([this, afterVisitCommand](IRenderer* renderer) {
    ...
    {
        //_director->multiplyMatrix(MATRIX_STACK_TYPE::MATRIX_STACK_VIEWPROJECTION, _mat);
    }
    
    void CameraNode::afterVisit()
    {
        //_director->multiplyMatrix(MATRIX_STACK_TYPE::MATRIX_STACK_VIEWPROJECTION, _mat.getInversed());
    }
}
