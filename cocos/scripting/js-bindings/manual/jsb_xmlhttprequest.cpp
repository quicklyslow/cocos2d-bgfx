...
{
    _resetDirectorListener = SharedDirector.getEventDispatcher()->addCustomEventListener(cocos2d::Director::EVENT_RESET, [this](cocos2d::EventCustom*){
...
XMLHttpRequest::~XMLHttpRequest()
{
    SharedDirector.getEventDispatcher()->removeEventListener(_resetDirectorListener);
    SharedDirector.getScheduler()->unscheduleAllForTarget(this);
...
void XMLHttpRequest::sendRequest()
{
    ...
    {
        SharedDirector.getScheduler()->schedule([this](float dt){
