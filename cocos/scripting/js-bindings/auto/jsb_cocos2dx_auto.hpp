...
extern se::Object* __jsb_cocos2d_Flag_proto;
extern se::Class* __jsb_cocos2d_Flag_class;

bool js_register_cocos2d_Flag(se::Object* obj);
bool register_all_cocos2dx(se::Object* obj);
SE_DECLARE_FUNC(js_cocos2dx_Flag_setOff);
SE_DECLARE_FUNC(js_cocos2dx_Flag_setValue);
SE_DECLARE_FUNC(js_cocos2dx_Flag_setOn);
SE_DECLARE_FUNC(js_cocos2dx_Flag_isOff);
SE_DECLARE_FUNC(js_cocos2dx_Flag_value);
SE_DECLARE_FUNC(js_cocos2dx_Flag_isOn);
SE_DECLARE_FUNC(js_cocos2dx_Flag_setFlag);
SE_DECLARE_FUNC(js_cocos2dx_Flag_toggle);
SE_DECLARE_FUNC(js_cocos2dx_Flag_Flag);
...
SE_DECLARE_FUNC(js_cocos2dx_Configuration_supportsASTC);
...
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_un7zip);
...
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_addJsEngineSearchPath);
...
SE_DECLARE_FUNC(js_cocos2dx_Label_setGradientColorEnd);
SE_DECLARE_FUNC(js_cocos2dx_Label_setTTFConfig);
SE_DECLARE_FUNC(js_cocos2dx_Label_setGradientAngle);
...
SE_DECLARE_FUNC(js_cocos2dx_Label_enableGradient);
...
SE_DECLARE_FUNC(js_cocos2dx_Label_setGradientColorStart);
...
bool register_all_cocos2dx(se::Object* obj);
SE_DECLARE_FUNC(js_cocos2dx_Application_getMacAddress);
SE_DECLARE_FUNC(js_cocos2dx_Application_getOpenUDID);
SE_DECLARE_FUNC(js_cocos2dx_Application_getTargetPlatform);
SE_DECLARE_FUNC(js_cocos2dx_Application_getAvailableMemory);
SE_DECLARE_FUNC(js_cocos2dx_Application_getCurrentLanguage);
SE_DECLARE_FUNC(js_cocos2dx_Application_getUDID);
SE_DECLARE_FUNC(js_cocos2dx_Application_getAdvertisingIdentifier);
SE_DECLARE_FUNC(js_cocos2dx_Application_openURL);
SE_DECLARE_FUNC(js_cocos2dx_Application_getVersion);
SE_DECLARE_FUNC(js_cocos2dx_Application_getIMEI);
