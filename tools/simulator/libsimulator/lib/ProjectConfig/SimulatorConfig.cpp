...
SimulatorConfig::SimulatorConfig()
{
	...
	_screenSizeArray.push_back(SimulatorScreenSize("iPhone X (1125x2436)", 1125, 2436));
...
void SimulatorConfig::makeNormalizePath(std::string *path, const char *directorySeparator/* = NULL*/)
{
